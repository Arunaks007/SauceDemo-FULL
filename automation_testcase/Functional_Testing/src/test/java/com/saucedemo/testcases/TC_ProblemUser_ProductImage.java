...
public class TC_ProblemUser_ProductImage extends BaseClass {
	
	@Test(description = "Verify whether the Problem user Products image is Unique",groups="ProblemUser")
	public void ProblemUserImage() throws Exception {
